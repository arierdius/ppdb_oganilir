...
<body>
    ...
    <footer>
        ...
        <div class="container foot-content">
            <div class="row">
                <div class="col-12 col-md-5 mb-5">
                    ...
                    <img src="{{ asset('assets_umum/images/oganilir-bangkit.png') }}" alt="logo" style="width: 30%">
                ...
                <div class="col-12 col-md-7 justify-content-end">
                    <div class="comon-footer">
                        ...
                        <ul class="list-unstyled">
                            <li><i class="bi bi-geo-alt-fill me-2"></i>{{$kontak->alamat}}</li>
                            <li><i class="bi bi-telephone-forward me-2"></i>{{$kontak->telp}}</li>
                            <li><i class="bi bi-envelope me-2"></i>{{ strtolower($kontak->email) }}</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row row-cols-1 row-cols-md-2 common-foot">
                <div class="col-lg-6 text-white mb-2"> © 2023 Diskominfo Kabupaten Ogan Ilir | All right reserved. </div>
                <div class="col-lg-6 justify-content-center justify-content-md-end mb-2">
                    <ul class="list-unstyled socal">
                        <li class="text-end"><a href="#"> <i class="bi bi-facebook"></i> </a></li>
                        <li class="text-end"><a href="#"> <i class="bi bi-twitter"></i> </a></li>
                        <li class="text-end"><a href="#"> <i class="bi bi-instagram"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
