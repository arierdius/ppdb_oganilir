                ...
                <div class="card">
                    <div class="card-body">
                        <form class="row g-3 needs-validation">
                            <div class="col-md-4">
                                <label>Surat PKH / KIP</label> <small>(PDF)</small>
                                <input type="file"
                                    class="form-control @error('pkh_kip_baru') is-invalid @enderror"
                                    wire:model="pkh_kip_baru">
                                <small>
                                    <a href="{{ asset('storage/data_pendaftaran/' . $pkh_kip) }}"
                                        target="_blank">
                                        <i class="fa fa-eye"> Lihat PKH / KIP</i></a></small>
                                @error('pkh_kip_baru')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                @enderror
                                <div wire:loading wire:target="pkh_kip_baru">Uploading...
                                </div>
                            </div>
                            <div class="col-md-4">
