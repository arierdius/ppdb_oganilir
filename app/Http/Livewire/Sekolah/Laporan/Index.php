...
class Index extends Component
{
    ...
    {
        return Excel::download(new LaporanSekolahExport, 'Laporan data - ' . $this->data_jalur . '.xlsx');
    }

    public function cetakDataPendaftarExcel()
    {
        return Excel::download(new LaporanPendaftarExport, 'Laporan data - ' . $this->data_jalur . '.xlsx');
    }
