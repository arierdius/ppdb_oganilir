            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">jalur-mutasi-pendaftaran</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <tbody>
                                    ...
                                    @forelse ($data_mutasi as $key_data_mutasi)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $key_data_mutasi->sekolah_lama }}</td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="{{ route('siswa.mutasi.cetak.index', ['id_siswa' => $key_data_mutasi->id_siswa]) }}"
                                            ...
                                            @if ($pengumuman_kelulusan->status_pengumuman != 'ditampilkan')
                                                <td>
                                                    ...
                                                    <a class="btn btn-info btn-xs"
                                                        href="{{ route('sekolah.revisi.mutasi.index', $key_data_mutasi->id) }}"><i
