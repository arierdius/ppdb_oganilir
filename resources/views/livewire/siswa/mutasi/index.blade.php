            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Jalur Mutasi</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @if ($pendaftaran->count() > 0)
                            ...
                            @if ($status_pendaftaran == 'sudah')
                                <center><b>Perhatian !</b> Anda Sudah Mendaftar Jalur Mutasi</center> <br>
                                <center>
                                    <a href="{{ route('siswa.mutasi.cetak.index') }}" class="btn btn-primary">Lihat
                        ...
                        @else
                            @if ($kontrol_jalur->count() < 1)
                                <center><b>Perhatian !</b> Jaluar Mutasi belum Dibuka</center>
                                <center>
                    ...
                    @if ($agama_user == 'islam')
                        ...
                        @else
                            <div class="col-md-6">
                    @endif
                    <label>File Mutasi Orang Tua</label>
                    <input type="file" class="form-control @error('sk_mutasi_orang_tua') is-invalid @enderror"
                        wire:model="sk_mutasi_orang_tua">
                    <small>Format : pdf</small>
                    @error('sk_mutasi_orang_tua')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    @enderror
                    <div wire:loading wire:target="sk_mutasi_orang_tua">Uploading...</div>
