    ...
    <table border="1" width="50%" style="font-size: 10px;">
        ...
        <tbody>
            ...
            {{-- <tr>
                ...
                <td>
                    {{-- @php
                    $afirmasi = $data_daya_tampung['porsi_afirmasi'];
                    $zonasi = $data_daya_tampung['porsi_zonasi'];
                    echo $afirmasi + $zonasi;
                    // echo $data_daya_tampung['porsi_afirmasi'] + $data_daya_tampung['porsi_mutasi'];
                    //    $total =  $data_daya_tampung['porsi_zonasi']+$data_daya_tampung['porsi_afirmasi']+$data_daya_tampung['porsi_mutasi']+$data_daya_tampung['porsi_prestasi'];
                        // echo $total;
                    @endphp
                </td>
            </tr> --}}
