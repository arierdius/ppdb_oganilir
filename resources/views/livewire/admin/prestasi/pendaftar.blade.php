            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">jalur-prestasi-pendaftaran</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <table class="table table-striped" style="font-size: 12px;">
                                ...
                                <tbody>
                                    ...
                                    @forelse ($data_prestasi as $key_data_prestasi)
                                        {{-- @dd($key_data_prestasi->sekolah_asal) --}}
                                        <tr>
                                            ...
                                            {{-- <td>{{ $key_data_prestasi->prestasi }}</td> --}}
                                            ...
                                            @if ($pengumuman_kelulusan->status_pengumuman != 'ditampilkan')
                                                <td>
                                                    ...
                                                    <button wire:click.prevent="dataId({{ $key_data_prestasi->id }})"
                                                        type="button" data-bs-toggle="modal" data-original-title="test"
                                                        data-bs-target="#ModalTolak" class="btn btn-danger btn-xs"><i <i
                                                            class="fa fa-times"></i> </button>
                                                    <a class="btn btn-info btn-xs"
                                                        href="{{ route('sekolah.revisi.prestasi.index', $key_data_prestasi->id) }}"><i
